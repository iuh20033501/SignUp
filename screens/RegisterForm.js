...
import { View, StyleSheet, Text, TouchableOpacity, Modal, TouchableWithoutFeedback, Alert } from 'react-native';
    ...
    <View style={styles.container}>
      ...
      <View style={styles.phoneInputContainer}>
        <PhoneInput
          ...
          style={{ height: 80, width: 300, borderRadius: 1, borderBlockColor: '#1c70be', alignItems: 'center' }}
      ...
      <View style={{ flexDirection: 'row', marginTop: 10, marginLeft: 50 }}>
        ...
        <TouchableOpacity onPress={onPressTerms}>
          <Text style={{ color: '#1c70be', marginTop: -2 }}> điều khoản sử dụng Zalo</Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={{ flexDirection: 'row', marginTop: 10, marginLeft: 50 }}>
        ...
        <TouchableOpacity onPress={onPressTerms}>
          <Text style={{ color: '#1c70be', marginTop: -2 }}>điều khoản Mạng xã hội của Zalo</Text>
        </TouchableOpacity>
      </View>

      <View>
        <TouchableOpacity
          style={[styles.button, { backgroundColor: isContinueEnabled ? '#1c70be' : '#d3d6db' }]}
          onPress={() => {
          ...
          <Text style={{ color: isContinueEnabled ? '#fff' : '#abaeb3', textAlign: 'center' }}>Tiếp tục</Text>
        </TouchableOpacity>
      </View>
      ...
      <Modal animationType="slide" transparent={true} visible={modalVisible} onRequestClose={() => handleCloseModal()}>
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            <Text style={{ fontSize: 17 }}>Nhận mã xác thực qua số {phoneNumber}</Text>
            <Text style={{ fontSize: 13, marginTop: 20 }}>Zalo sẽ gửi mã xác thực cho bạn qua số điện thoại này</Text>
            ...
            <TouchableOpacity
              ...
              <Text style={{ color: '#0867ef', textAlign: 'center', fontSize: 15, marginTop: 5 }}>Tiếp tục</Text>
            </TouchableOpacity>
            <View style={styles.separator} />
            <TouchableOpacity onPress={rollback}>
              <Text style={{ textAlign: 'center', fontSize: 15, marginTop: 5 }}>Đổi số khác</Text>
            </TouchableOpacity>
          </View>
        </View>
      </Modal>
      ...
      <Modal animationType="slide" transparent={true} visible={successModalVisible} onRequestClose={() => handleCloseModal()} >
        <View style={styles.modalContainer}>
          <View style={styles.modalContent2}>
            <Text style={{ fontSize: 20, textAlign: 'center', fontWeight: 'bold' }}>Gửi OTP thành công</Text>
            <View style={styles.separator} />
            <Text>• Mã đã được gửi, kiểm tra điện thoại của bạn</Text>
            <Text>• OTP chỉ có hiệu lực trong vòng 30s</Text>
            <TouchableOpacity onPress={() => {
              handleCloseModal();
              navigation.navigate('Authentication', { phoneNumber: phoneNumber })
            }}>
      ...
      <Modal animationType="fade" transparent={true} visible={failureModalVisible} onRequestClose={() => handleCloseModal()}>
        <View style={styles.modalContainer}>
          <View style={styles.modalContent2}>
            ...
            <Text style={{ fontSize: 20, textAlign: 'center', fontWeight: 'bold' }}>Gửi OTP thất bại</Text>
            <View style={styles.separator} />
